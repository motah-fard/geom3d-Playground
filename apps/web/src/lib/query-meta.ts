...
export const QUERY_META: Record<QueryType, QueryMeta> = {
  ...
  "solids-3d": {
    ...
    description: "Volume and surface area of the six solids every geometry class covers: cube, rectangular prism, cylinder, cone, sphere, and square pyramid.",
    instruction: "Pick a solid, then drag its dimension points and watch the volume and surface area respond.",
    accent: "#fbbf24",
    difficulty: "Beginner",
  },
  "cross-sections": {
    ...
    description: "Slice a cone with a plane at a variable tilt and watch the cut change from a circle, to an ellipse, to a parabola, to a hyperbola — the four classical conic sections, all from one cone.",
    instruction: "Drag the tilt handle to change the cutting angle, or the offset to move the plane along the axis.",
    accent: "#38bdf8",
    difficulty: "Intermediate",
  },
  "nets": {
    ...
    title: "Nets",
    shortTitle: "Nets",
    description: "A cube's net — six squares hinged together — folding continuously from flat into the solid it forms.",
    instruction: "Drag the fold handle from 0 to 1 to unfold or fold the cube.",
    accent: "#f472b6",
    difficulty: "Beginner",
  },
